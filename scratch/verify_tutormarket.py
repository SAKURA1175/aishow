...
# 3. Check for lingering sweet-shop terms
print("\n--- Scanning for lingering e-commerce/sweet-shop terms ---")
keywords = ['甜品', '商品', '顾客', '购物车', '结账', '送货', '订单']
found_occurrences = []
...
if found_occurrences:
    ...
    print("Zero old domain keywords found! TutorMarket AI document is 100% clean and correct!")
